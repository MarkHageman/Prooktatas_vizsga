...
var productsSection = document.getElementById('card-products');
products.forEach(function (product) {
  productsSection.innerHTML += "<div class=\"card-products m-2 p-3\">\n    <h2 class=\"m-1 p-1\">".concat(product.title, "</h2> \n    <img class=\"m-1 p-1\" src=\"./img/").concat(product.cover, "\">\n    <h3 class=\"m-1 p-1\">").concat(product.author, "</h3>\n    <p class=\"m-1 p-1\">").concat(product.style, "</p>\n    <p class=\"m-1 p-1\">").concat(product.price, " FT</p>\n</div>");
});